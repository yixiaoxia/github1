...
public class SipProvider implements Configurable, TransportListener, TcpServerListener
{
   ...
   {  ConnectionIdentifier conn_id=new ConnectionIdentifier(proto,dest_ipaddr,dest_port);
   	  System.out.println("msg: "+msg.getMessage());//songadd systemout
   	  System.out.println("ip: "+dest_ipaddr+" port: "+dest_port);
    ...
    //FIXME song this is a send meassage
   ...
   {  try
      {  // logs
         ...
         // try to look for a UA in promisque mode  1
         ...
         // after the callback check if the message is still valid  2
         ...
         // try to look for a transaction  3
         ...
         // try to look for a default UA    6
   ...
   /** When a new SIP message is received. implement TransportListener*/
